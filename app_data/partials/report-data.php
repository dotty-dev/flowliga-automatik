...
function get_game_data_manual($manual_report)
{
  $game_data_manual = json_decode($manual_report);
  ...
  $players = [
    1 => [
      ...
      "legsWon" => $game_data_manual["p1_legsWon"],
    ],
    2 => [
      ...
      "legsWon" => $game_data_manual["p2_legsWon"],
    ]
  ];
